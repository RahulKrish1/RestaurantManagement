...
public class DirectorSerialization02Test {
    ...
    public static void main(String[]args) {
        ...
        String fileName = "serializedDirector02.ser";
		...
		for (menuId = 1; menuId <= 3; menuId++) {
			for (String customer : list) {
				...
				answer.append("Report for " + customer + " Menu # " + menuId + "\n" + restoredDirector.getMenuReport(customer, menuId) + "\n\n");
			}
		}
		
		for (menuId = 1; menuId <= 3; menuId++) {
			answer.append("Minimum for Menu # " + menuId + " " + restoredDirector.getMinAmount(menuId) + "\n");
			answer.append("Maximum for Menu # " + menuId + " " + restoredDirector.getMaxAmount(menuId) + "\n");
			answer.append("Average for Menu # " + menuId + " " + (int)restoredDirector.getAveragePerMenu(menuId) + "\n");
		}
